...
#         self.add(tf.keras.layers.Conv2D(name='Conv_2',filters=32,kernel_size=(2,3),activation='relu'))
...
def VoiceVerificationCNN(input_shape, output_shape):
    """
    model structure
    """
...
if __name__ == '__main__':
    ...
    # create model
    model = VoiceVerificationCNN((100, 100, 1), 5)
    # save model
